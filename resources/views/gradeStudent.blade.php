    ...
    <div class="p-0 sm:pl-64 w-full h-screen">
        <nav>
            ...
            <ol class="flex flex-wrap pt-1 mx-6 mt-4 bg-transparent rounded-lg sm:mr-16">
                ...
                <li class="text-sm pl-2 capitalize leading-normal text-black before:float-left before:pr-2 before:text-black before:content-['/']" aria-current="page">Grade Student</li>
            </ol>
            <h6 class="mx-6 font-bold text-black capitalize">Grade Student</h6>
        </nav>
                                        ...
                                        <tr>
                                            @foreach ($chunk as $student)
                                                <td class="border px-4 py-2 font-bold w-1/4">
                                                    <a href="/grading/{{ $student->id }}">{{ $student->lName }}, {{ $student->fName }} {{ $student->mName }}</a>
                                                </td>
                                            @endforeach
